...
const onError = (err: Error, res: ServerResponse) => {
    res.writeHead(404, {
...
createServer((req, res) => {
    ...
    if (q.appid && q.addr) {
        ...
        get('https://api.steampowered.com/IGameServersService/GetServerList/v1/?filter=\\appid\\' + filter_appid + '\\addr\\' + filter_addr + '&key=' + STEAM_WEB_API_KEY, apiRes => {
            let data = '';
